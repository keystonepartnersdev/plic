...
- [ ] deals/[did]/page.tsx - calculateTotalDiscount useMemo 적용
- [ ] deals/page.tsx - 필터링 useMemo + 핸들러 useCallback
- [ ] deals/new/page.tsx - 핸들러들 useCallback
- [ ] page.tsx (홈) - 필터링 useMemo
- [ ] mypage/page.tsx - 필터링 useMemo
- [ ] DraftDealCard.tsx - React.memo
