...
| 홈 | `/` | ✅ 완료 (배너, 거래요약, FAQ) |
| 로그인 | `/auth/login` | ✅ 완료 |
| 회원가입 | `/auth/signup` | ✅ 완료 (5단계: 약관→**카카오인증**→정보→사업자→완료) — **팝빌 사업자 인증 필수 복구 완료 (2026-04-06)** |
| 거래 목록 | `/deals` | ✅ 완료 |
| 거래 상세 | `/deals/[did]` | ✅ 완료 — **수취인 수정 팝빌 계좌 인증 필수 복구 완료 (2026-04-06)** |
| 새 송금 | `/deals/new` | ✅ 완료 (5단계 위저드) — **팝빌 계좌 인증 필수 복구 완료 (2026-04-06)** |
| 결제 | `/payment/[did]` | ✅ 완료 |
