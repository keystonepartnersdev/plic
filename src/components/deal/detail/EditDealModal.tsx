            ...
            return (
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">
                  수수료 ({deal.feeRate}%, 부가세 포함): {Math.floor(Math.ceil(amount * deal.feeRate / 100) * 1.1).toLocaleString()}원
                </p>
                <p className="text-sm font-medium text-primary-400">
                  총 결제금액: {(amount + Math.floor(Math.ceil(amount * deal.feeRate / 100) * 1.1)).toLocaleString()}원
                </p>
