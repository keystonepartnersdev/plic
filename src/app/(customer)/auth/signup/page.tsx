...
type Step = 'agreement' | 'info' | 'verify' | 'complete';
...
export default function SignupPage() {
  ...
  const isValidPassword = (password: string) => {
    // Cognito 요구사항: 8자 이상, 대문자, 소문자, 숫자, 특수문자
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              {password && !isValidPassword(password) && (
                <p className="text-sm text-red-500 mt-1">비밀번호는 8자리 이상이어야 합니다.</p>
              )}
            </div>
