                ...
                filteredUsers.map((user) => {
                  ...
                  return (
                    <tr key={user.uid} className="border-b border-gray-50 hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">{user.phone.replace(/(\d{3})(\d{4})(\d{4})/, '$1-$2-$3')}</p>
                      ...
                      <td className="px-6 py-4">
                        <p className="text-sm text-gray-900">{user.totalDealCount}건</p>
                        <p className="text-xs text-gray-500">{user.totalPaymentAmount.toLocaleString()}원</p>
                      </td>
