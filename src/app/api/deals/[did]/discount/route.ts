/**
 * 거래 할인 적용 프록시
 * POST /api/deals/[did]/discount - 할인 적용
 */
...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(`${API_BASE_URL}/deals/${did}/discount`, {
      method: 'POST',
      headers: {
    ...
    console.error('[API Proxy] /deals/[did]/discount POST error:', error);
    return NextResponse.json(
