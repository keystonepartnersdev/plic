// 기본 FAQ 데이터 (40개) - API 응답이 없을 때 사용
...
거래 유형에 따라 필수 서류가 다르며, 검토 과정에서 추가 증빙이 요청될 수 있습니다.`,
  ...
  // 2. 결제/수수료 (9개)
  {
    faqId: 'default-9',
    question: '수수료는 얼마인가요?',
    answer: '현재 베타 버전 기준 수수료는 4.0%입니다. 예를 들어, 100만원을 송금하려면 100만원 + 수수료 40,000원 = 총 1,040,000원을 결제하시면 됩니다. 수수료율은 추후 거래량 등에 따라 변경될 수 있습니다.',
    category: '결제/수수료',
    isVisible: true,
    isHomeFeatured: true,
    priority: 1,
...
// 홈 화면용 FAQ (isHomeFeatured: true인 것만)
export const DEFAULT_HOME_FAQS = DEFAULT_FAQS.filter(f => f.isHomeFeatured);
